...
var require_sax = __commonJS({
  "node_modules/sax/lib/sax.js"(exports) {
    (function(sax) {
      ...
      var Stream;
      try {
        Stream = (init_stream(), stream_exports).Stream;
      } catch (ex) {
        Stream = function() {
        };
      }
      ...
      SAXStream.prototype.write = function(data) {
        if (typeof Buffer === "function" && typeof Buffer.isBuffer === "function" && Buffer.isBuffer(data)) {
          if (!this._decoder) {
            var SD = (init_string_decoder(), string_decoder_exports).StringDecoder;
...
// dep:xml-js
var xml_js_default = require_lib();
export {
  xml_js_default as default
};
