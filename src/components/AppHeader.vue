<template>
    <nav class="flex gap-4 items-center flex-wrap justify-between shadow-lg bg-white p-4">
        ...
        <div class="flex items-center gap-8 flex-wrap">
            <div class="">
                <uploader
                    v-if="mainStore.done.length === 0"
                    parse-xml
                    @uploaded="parseSaveGame"
                    label="Upload Game Save (PC only)"
                />
                <app-button v-else @click="reset">Reset Progress</app-button>
            </div>
            ...
            <div class="flex gap-2 flex-wrap justify-center items-center">
                ...
                <div class="flex gap-2 flex-wrap justify-center items-center">
                    <app-button
                        ...
                        :class="
                            hasFilter(x)
                                ? 'bg-gradient-to-l from-sea-green to-blue-green'
                                : '!bg-white !text-blue-green'
                        "
